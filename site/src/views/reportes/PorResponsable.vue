<template>
  <div class="mante w-100">
    <el-card>
      <h3 class="gris titulo">Reporte Por Responsable</h3>
...
export default {
  data: () => ({
    ...
    datos: [],
    url: '/api/reportes/por-responsable'
  }),
  methods: {
    async cargarInfo() {
      ...
      var especialista_id = this.especialista_id
      if (!especialista_id) {
        especialista_id = '*'
      }
