<template>
  <div class="mante w-100">
    <el-card>
      <div>
        <h3 class="gris titulo">Solicitante</h3>
        <div class="opciones">
          <el-button
            size="mini"
      ...
      <el-table :data="datos" style="width: 100%" size="mini">
        <el-table-column prop="solicitante_id" label="Id" width="100" sortable>
        </el-table-column>
        <el-table-column prop="solicitante_desc" label="Nombre" sortable>
        </el-table-column>
        <el-table-column
          prop="estatus"
          label="Estatus"
    ...
    >
      <div class="detalle">
        <div class="row">
          <div>Id</div>
          <div>{{ model.solicitante_id }}</div>
        </div>
        <div class="row">
          <div>Nombre</div>
          <div>{{ model.solicitante_desc }}</div>
        </div>
        <div class="row">
          <div>Correo</div>
          <div>{{ model.coreo }}</div>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          type="danger"
          @click="eliminarRegistro(model.solicitante_id)"
          v-if="!tipoDetalle"
          >Eliminar</el-button
        >
      </span>
    ...
    >
      <el-form
        ...
        size="mini"
      >
        <el-form-item label="Id" prop="solicitante_id">
          <el-input
        ...
        <el-form-item label="Nombre" prop="solicitante_desc">
          <el-input v-model="model.solicitante_desc"></el-input>
        </el-form-item>
    ...
    editarRegistro() {
      this.$refs.form1.validate(async (valid) => {
        if (valid) {
          ...
          try {
            await this.$http.put(
              this.url + '/' + this.model.solicitante_id,
              this.model
            )
